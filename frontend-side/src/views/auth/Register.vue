<template>
  <Transition>
    <template v-if="firstStep" id="firstCreate">
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6">
                ...
                <div
                  ...
                  class="duration-300 w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Create an account
                </div>
  ...
  <Transition>
    <template v-if="secondStep" id="generalInformation">
      <form class="mx-4 lg:mx-56">
